...
module tb_asyncfifo;
    ...
    initial begin
        ...
        pop_set = 1; @(posedge clk); pop_set = 0; #1;
        ...
        mask_in = 4'b1111;
        push = 1; @(posedge clk); push = 0; #1; // load 4 chunks
        // Now push new data and pop simultaneously
        data_in = 64'h00E0_00F0_0010_0020;
        mask_in = 4'b1111;
        push = 1; pop = 1; @(posedge clk); push = 0; pop = 0; #1;
        ...
        mask_in = 4'b1111;
        push = 1; pop_set = 1; @(posedge clk); push = 0; pop_set = 0; #1;
