...
# Purely combinational modules (no clk port) -> sdc/comb.sdc (virtual clock)
# All other modules are sequential -> sdc/seq_unit.sdc or sdc/seq_top.sdc
set MOD_COMBINATIONAL {Decoder VMULU VADDU}

# Modules that instantiate SRAM hard macros (directly or via sub-modules)
set MOD_HAS_SRAM {DataMemory EXE_M_Stage ProcessElement}

# Integration-level modules: use tighter I/O constraints (seq_top.sdc) + gate_clock
