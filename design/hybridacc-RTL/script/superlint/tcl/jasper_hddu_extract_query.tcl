...
set ::HACC_JG_RUN_DIR [file join $repo_root output jasper_hddu_extract run]
...
set hddu_instances [get_design_info -module HybridDataDeliverUnit -list instance -silent]
set hddu_instance [lindex $hddu_instances 0]
puts "HDDU_INSTANCE=$hddu_instance"

check_superlint -extract -instances [list $hddu_instance]

set comb_loop_tags {MOD_IS_CMBL MOD_IS_FCMB}
puts "HDDU_COMB_LOOP_DETAILS_BEGIN"
foreach tag $comb_loop_tags {
    set comb_ids [check_superlint -list -severity error -instance $hddu_instance -tag [list $tag] -silent]
...
puts "HDDU_COMB_LOOP_DETAILS_END"
