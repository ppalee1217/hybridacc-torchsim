...
set scratchpadmemory_srcs [list \
    [hacc_src Cluster AddressGenerateUnit.sv] \
    [hacc_src Cluster ScratchpadMemoryBank.sv] \
    [hacc_src Cluster ScratchpadMemory.sv]]
set computecluster_srcs [list \
    [hacc_src FIFO.sv] \
    [hacc_src asyncFIFO.sv] \
    [hacc_src Cluster AddressGenerateUnit.sv] \
    [hacc_src Cluster ScratchpadMemoryBank.sv] \
    [hacc_src Cluster ScratchpadMemory.sv] \
    [hacc_src Cluster HybridDataDeliverUnit.sv] \
    ...
    [hacc_src Cluster ComputeCluster.sv]]
...
set MOD_SRCS(AddressGenerateUnit) [list [hacc_src Cluster AddressGenerateUnit.sv]]
set MOD_SRCS(ScratchpadMemory) $scratchpadmemory_srcs
set MOD_SRCS(HybridDataDeliverUnit) [list \
    [hacc_src FIFO.sv] \
    [hacc_src Cluster AddressGenerateUnit.sv] \
    [hacc_src Cluster HybridDataDeliverUnit.sv]]
...
if {[lsearch -exact $MOD_INTEGRATION $MOD_NAME] >= 0} {
    puts "INFO: $MOD_NAME -- compile_ultra -gate_clock + optimize_netlist -area"
