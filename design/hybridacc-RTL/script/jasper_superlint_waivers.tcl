...
foreach {module_name tag_list} {
    FIFO                    {BLK_NO_RCHB}
    asyncFIFO               {BLK_NO_RCHB}
    DataMemory              {BLK_NO_RCHB}
