...
public:
    ...
    VRDIF<noc_addr_req_t> noc2_req;
    VRDOF<noc_response_t> noc2_resp;
    ...
    void bind() {
        ...
        bind_vr_interface(router.noc2_req_in_if, noc2_req);
        bind_vr_interface(noc2_resp, router.noc2_resp_out_if);
