...
#define DMA_OP_KIND         (DMA_MMIO_BASE + 0x00C)
#define DMA_SRC_KIND        (DMA_MMIO_BASE + 0x010)
#define DMA_DST_KIND        (DMA_MMIO_BASE + 0x014)
#define DMA_SRC_ADDR_LO     (DMA_MMIO_BASE + 0x018)
#define DMA_SRC_ADDR_HI     (DMA_MMIO_BASE + 0x01C)
#define DMA_DST_ADDR_LO     (DMA_MMIO_BASE + 0x020)
#define DMA_DST_ADDR_HI     (DMA_MMIO_BASE + 0x024)
#define DMA_SRC_CLUSTER_ID  (DMA_MMIO_BASE + 0x028)
#define DMA_DST_CLUSTER_ID  (DMA_MMIO_BASE + 0x02C)
#define DMA_BYTES           (DMA_MMIO_BASE + 0x030)
#define DMA_LINE_BYTES      (DMA_MMIO_BASE + 0x034)
#define DMA_LINE_COUNT      (DMA_MMIO_BASE + 0x038)
#define DMA_SRC_STRIDE      (DMA_MMIO_BASE + 0x03C)
#define DMA_DST_STRIDE      (DMA_MMIO_BASE + 0x040)
#define DMA_CMD_TAG         (DMA_MMIO_BASE + 0x044)
#define DMA_DONE_TAG        (DMA_MMIO_BASE + 0x048)
#define DMA_ERR_CODE        (DMA_MMIO_BASE + 0x04C)
#define DMA_ERR_INFO        (DMA_MMIO_BASE + 0x050)
#define DMA_DEBUG_STATE     (DMA_MMIO_BASE + 0x054)
