...
> Legacy ESL developer guide. Repo-wide 操作入口請先看 [../../../../doc/index.md](../../../../doc/index.md) 與 [../../../../doc/user-manual/esl-workflows.md](../../../../doc/user-manual/esl-workflows.md)；本文件保留 ESL 內部結構與開發細節。
...
```bash
# Core pipeline trace
scripts/setup.sh fast hybridacc-sim run-task <dir> --core-debug --max-cycles 100000
```
...
```bash
# 開啟 DMA loopback 檢查
scripts/setup.sh fast hybridacc-sim run-task <dir> --dma-check
```
...
scripts/setup.sh fast hybridacc-sim run-task <dir> --max-cycles 50000
