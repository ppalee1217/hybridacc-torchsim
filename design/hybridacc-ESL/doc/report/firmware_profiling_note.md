...
- wave gap 的 source of truth 是 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L71-L90](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L71-L90) 的 WaveGapInstructionStats，實際探針執行在 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1234](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1234) 附近的 wave_gap_probe_thread。
- simulator 只是在 [design/hybridacc-ESL/simulator/src/main.cpp#L779-L856](design/hybridacc-ESL/simulator/src/main.cpp#L779-L856) 把統計列印成 [SIM] log；Python 端再由 [python/hybridacc_cc/sweep_tools.py#L74-L115](python/hybridacc_cc/sweep_tools.py#L74-L115) 與 [scripts/others/summarize_wave_gap_results.py#L13-L33](scripts/others/summarize_wave_gap_results.py#L13-L33) 解析。
...
- top-level HybridAcc 對外暴露四類和 profiling 直接相關的 live counter / probe accessor：
  - cluster busy cycles: [design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L438-L443](design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L438-L443)
  - DMA active cycles: [design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L445](design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L445)
  - compute/DMA overlap cycles: [design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L447-L452](design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L447-L452)
  - wave gap stats: [design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L454-L456](design/hybridacc-ESL/simulator/include/HybridAcc.hpp#L454-L456)

- wave gap 統計結構定義在 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L71-L90](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L71-L90)。
...
- wave gap probe thread 是一個獨立的 SystemC thread，由 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L691](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L691) 註冊，主體在 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1234-L1319](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1234-L1319)。

- cluster START/STOP 不是靠 trace 後處理推測，而是直接 decode MCU 的 MMIO request：
  - decode entry: [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1040-L1059](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1040-L1059)
  - 只接受 write request
...
- 直接負責切窗與累加的 helper 在：
  - start window: [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1135-L1158](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1135-L1158)
  - finish window: [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1160-L1207](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1160-L1207)
  - instruction bucket accounting: [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1120-L1133](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1120-L1133)

### 1.3 boot-up / drain-out / partial windows

- boot-up 由 core enable 到第一個 cluster START，helper 在 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1209-L1218](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1209-L1218)。

- drain-out 由最後一個 cluster STOP 到 MCU halt，helper 在 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1220-L1232](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1220-L1232)。
...
- log producer 在 [design/hybridacc-ESL/simulator/src/main.cpp#L779-L856](design/hybridacc-ESL/simulator/src/main.cpp#L779-L856)。
...
### 2.2 次要 summarizer: summarize_wave_gap_results.py

- 這支 script 直接面向 sim.log 聚合多個 result dir。

- pattern 定義在 [scripts/others/summarize_wave_gap_results.py#L13-L33](scripts/others/summarize_wave_gap_results.py#L13-L33)。

- 它在說明段落中明確寫死目前 wave gap 的定義：
  - [scripts/others/summarize_wave_gap_results.py#L224](scripts/others/summarize_wave_gap_results.py#L224)
  - boot-up / drain-out 語意說明在 [scripts/others/summarize_wave_gap_results.py#L230-L231](scripts/others/summarize_wave_gap_results.py#L230-L231)
...
- 目前在 main.cpp 中明確讀 DSRAM word 的已知位置是 [design/hybridacc-ESL/simulator/src/main.cpp#L893-L896](design/hybridacc-ESL/simulator/src/main.cpp#L893-L896)。
...
- 任何改到 HDDU STOP / START MMIO 位址或 bit 定義的修改，都要同步改 [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1040-L1059](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp#L1040-L1059)，不然 simulator 會誤判 window 邊界。
...
1. simulator probe definition
   - [design/hybridacc-ESL/simulator/include/Core/CoreController.hpp](design/hybridacc-ESL/simulator/include/Core/CoreController.hpp)

2. simulator log surface
   - [design/hybridacc-ESL/simulator/src/main.cpp](design/hybridacc-ESL/simulator/src/main.cpp)

3. Python parser / derived metrics
   - [python/hybridacc_cc/sweep_tools.py](python/hybridacc_cc/sweep_tools.py)
   - [scripts/others/summarize_wave_gap_results.py](scripts/others/summarize_wave_gap_results.py)
