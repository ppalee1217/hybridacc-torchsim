...
def prepare_template_context(hw_ir: HardwareIR,
    ...
    for i, layer in enumerate(hw_ir.layers):
        ...
        layers_ctx.append({
            ...
            "gemm_kernel_prefetch_offset": lp.get("gemm_kernel_prefetch_offset"),
            "gemm_kernel_load_offset": lp.get("gemm_kernel_load_offset"),
            "gemm_kernel_reuse_offset": lp.get("gemm_kernel_reuse_offset"),
            "tiling": {
                ...
                "dram_out_row_stride": tp.dram_out_row_stride,
                ...
                "input_pad_enable": 1 if tp.input_pad_enable else 0,
                "input_padding": tp.input_padding,
                "input_stride": tp.input_stride,
                "input_src_h": tp.input_src_h,
                "input_src_w": tp.input_src_w,
                "input_fill_mode": tp.input_fill_mode,
                "input_fill_value_lo": tp.input_fill_value_lo,
                "input_fill_value_hi": tp.input_fill_value_hi,
                "output_epilogue": tp.output_epilogue,
                "output_epilogue_param0": tp.output_epilogue_param0,
                ...
                "conv1x1_resident_oc_tiles": tp.conv1x1_resident_oc_tiles,
                "gemm_resident_m_tiles": tp.gemm_resident_m_tiles,
                "gemm_resident_n_tiles": tp.gemm_resident_n_tiles,
                "gemm_pd_preload_m_tiles": tp.gemm_pd_preload_m_tiles,
            },
        })
